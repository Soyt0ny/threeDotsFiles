...
require("lazy").setup({
  spec = {
    ...
    -- { import = "lazyvim.plugins.extras.editor.snacks_picker" }, -- Removed: redundant with fzf

    -- Debgugging plugins
    { import = "lazyvim.plugins.extras.dap.core" },

    -- Formatting plugins
    -- { import = "lazyvim.plugins.extras.formatting.biome" }, -- Removed: redundant with prettier
